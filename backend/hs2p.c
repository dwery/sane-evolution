...
attach(SANE_String_Const devname, HS2P_Device ** devp)
{
	 ...
	 */
	dev->info.hasIPU =
		(vbuf.ipu_id & 0x01) == 0x01 ? SANE_TRUE : SANE_FALSE;
	dev->info.hasXBD =
		(vbuf.ipu_id & 0x02) == 0x02 ? SANE_TRUE : SANE_FALSE;
