...
static SANE_Status usb_mid_n600_prepare_rgb(ma1017 * chip, int dpi);

static SANE_Status usb_mid_n600_prepare_mono(ma1017 * chip, int dpi);
...
static SANE_Status usb_mid_c600_prepare_rgb(ma1017 * chip, int dpi);

static SANE_Status usb_mid_c600_prepare_mono(ma1017 * chip, int dpi);
...
static SANE_Status usb_mid_c300600_prepare_rgb(ma1017 * chip, int dpi);

static SANE_Status usb_mid_c300600_prepare_mono(ma1017 * chip, int dpi);
...
static SANE_Status usb_mid_c300_prepare_rgb(ma1017 * chip, int dpi);

static SANE_Status usb_mid_c300_prepare_mono(ma1017 * chip, int dpi);
...
static SANE_Bool usb_mid_sensor_is600_mode(ma1017 * chip, int dpi);

static SANE_Status usb_mid_sensor_prepare_rgb(ma1017 * chip, int dpi);

static SANE_Status usb_mid_sensor_prepare_mono(ma1017 * chip, int dpi);
...
static SANE_Status usb_mid_motor1200_prepare_mono_half_300_dpi(ma1017 * chip);
...
static int usb_mid_motor1200_rgb_capability(int dpi);

static int usb_mid_motor1200_mono_capability(int dpi);
...
static SANE_Status usb_mid_motor600_prepare_rgb(ma1017 * chip, int dpi);
...
static int usb_mid_motor600_rgb_capability(int dpi);

static int usb_mid_motor600_mono_capability(int dpi);

/* ------------------ motor function declarations ------------------------ */

static SANE_Status usb_mid_motor_prepare_home(ma1017 * chip);

static SANE_Status usb_mid_motor_prepare_rgb(ma1017 * chip, int dpi);

static SANE_Status usb_mid_motor_prepare_mono(ma1017 * chip, int dpi);
...
static int usb_mid_motor_rgb_capability(ma1017 * chip, int dpi);

static int usb_mid_motor_mono_capability(ma1017 * chip, int dpi);
...
#if 0
/* CCD */
static int usb_mid_frontend_max_offset_index(ma1017 * chip);
