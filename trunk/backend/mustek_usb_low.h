...
typedef struct ma1017
{
	...
	int cmt_table_length_word;
	int cmt_second_pos_word;
	int row_size;
	int soft_resample;
	int total_lines;
	int lines_left;
...
static SANE_Status usb_low_turn_frontend_mode(ma1017 * chip, SANE_Bool is_on);
...
static SANE_Status usb_low_set_ccd_width(ma1017 * chip, int ccd_width);

/* A11 + A8ID6 */
static SANE_Status usb_low_get_a11(ma1017 * chip, SANE_Byte * value);

static SANE_Status usb_low_set_dummy(ma1017 * chip, int dummy);
