...
/* $Id: snapscan.h,v 1.41 2006-02-02 21:28:05 oliver-guest Exp $
...
typedef struct snapscan_device
{
	...
	char *firmware_filename;	/* The name of the firmware file for USB scanners */
