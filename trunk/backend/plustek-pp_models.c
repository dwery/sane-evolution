 ...
 */
static void
modelInitPageSettings(pScanData ps)
{
 ...
 */
static void
modelSetBufferSizes(pScanData ps)
{
...
ModelSet4800(pScanData ps)
{
	...
	ps->Device.buttons = 0;
	ps->Device.ModelCtrl =
		(_ModelDpi300 | _ModelMemSize32k96001 | _ModelWhiteIs0);
...
ModelSet4830(pScanData ps)
{
	...
	ps->Device.buttons = 1;
	ps->Device.ModelCtrl =
		(_ModelDpi300 | _ModelMemSize32k3 | _ModelWhiteIs0);
	ps->Device.DataOriginX = 72;
...
ModelSetA3I(pScanData ps)
{
	...
	ps->Device.ModelCtrl =
		(_ModelDpi400 | _ModelMemSize128k4 | _ModelWhiteIs0);
...
ModelSet9630(pScanData ps)
{
	...
	ps->Device.ModelCtrl =
		(_ModelDpi600 | _ModelMemSize128k4 | _ModelWhiteIs0);
