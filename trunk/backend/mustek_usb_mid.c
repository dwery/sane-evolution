...
static int usb_mid_n600_optical_x_dpi[] =
...
usb_mid_n600_prepare_rgb_600_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_image_dpi(chip, TRUE, SW_P6P6));
	RIE(usb_low_set_soft_resample(chip, 1));
	RIE(usb_low_set_led_light_all(chip, FALSE));
...
usb_mid_n600_prepare_rgb_400_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_image_dpi(chip, TRUE, SW_P4P6));
	RIE(usb_low_set_soft_resample(chip, 1));
	RIE(usb_low_set_led_light_all(chip, FALSE));
...
usb_mid_n600_prepare_rgb_300_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_image_dpi(chip, TRUE, SW_P3P6));
	RIE(usb_low_set_soft_resample(chip, 1));
	RIE(usb_low_set_led_light_all(chip, FALSE));
...
usb_mid_n600_prepare_rgb_200_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_image_dpi(chip, TRUE, SW_P2P6));
	RIE(usb_low_set_soft_resample(chip, 1));
	RIE(usb_low_set_led_light_all(chip, FALSE));
...
usb_mid_n600_prepare_rgb_100_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_image_dpi(chip, TRUE, SW_P1P6));
	RIE(usb_low_set_soft_resample(chip, 1));
	RIE(usb_low_set_led_light_all(chip, FALSE));
...
usb_mid_n600_prepare_mono_600_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_image_dpi(chip, TRUE, SW_P6P6));
	RIE(usb_low_set_soft_resample(chip, 1));
	RIE(usb_low_set_led_light_all(chip, TRUE));
...
SANE_Status
usb_mid_n600_prepare_rgb(ma1017 * chip, int dpi)
{
...
SANE_Status
usb_mid_n600_prepare_mono(ma1017 * chip, int dpi)
{
...
static int usb_mid_c600_optical_x_dpi[] =
...
usb_mid_c600_prepare_rgb_600_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_image_dpi(chip, FALSE, SW_P6P6));
	RIE(usb_low_set_soft_resample(chip, 1));
	RIE(usb_low_set_led_light_all(chip, FALSE));
...
usb_mid_c600_prepare_rgb_400_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_image_dpi(chip, FALSE, SW_P4P6));
	RIE(usb_low_set_soft_resample(chip, 1));
	RIE(usb_low_set_led_light_all(chip, FALSE));
...
usb_mid_c600_prepare_rgb_300_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_image_dpi(chip, FALSE, SW_P3P6));
	RIE(usb_low_set_soft_resample(chip, 1));
	RIE(usb_low_set_led_light_all(chip, FALSE));
...
usb_mid_c600_prepare_rgb_200_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_image_dpi(chip, FALSE, SW_P2P6));
	RIE(usb_low_set_soft_resample(chip, 1));
	RIE(usb_low_set_led_light_all(chip, FALSE));
...
usb_mid_c600_prepare_rgb_100_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_image_dpi(chip, FALSE, SW_P1P6));
	RIE(usb_low_set_soft_resample(chip, 1));
	RIE(usb_low_set_led_light_all(chip, FALSE));
...
SANE_Status
usb_mid_c600_prepare_rgb(ma1017 * chip, int dpi)
{
...
SANE_Status
usb_mid_c600_prepare_mono(ma1017 * chip, int dpi)
{
...
static int usb_mid_c300600_optical_x_dpi[] =
	{ 600, 400, 300, 200, 150, 100, 50, 0 };
...
SANE_Status
usb_mid_c300600_prepare_rgb(ma1017 * chip, int dpi)
{
...
SANE_Status
usb_mid_c300600_prepare_mono(ma1017 * chip, int dpi)
{
	switch (dpi) {
	case 50:
...
static int usb_mid_c300_optical_x_dpi[] = { 300, 200, 150, 100, 50, 0 };
...
SANE_Status
usb_mid_c300_prepare_rgb(ma1017 * chip, int dpi)
{
...
SANE_Status
usb_mid_c300_prepare_mono(ma1017 * chip, int dpi)
{
...
SANE_Bool
usb_mid_sensor_is600_mode(ma1017 * chip, int dpi)
{
	if (chip->sensor == ST_CANON300) {
		...
		case 50:
			DBG(6,
			    "usb_mid_sensor_is600_mode: chip=%p, dpi=%d, FALSE\n",
			    (void *) chip, dpi);
			return FALSE;
		case 600:
		case 400:
		case 200:
			DBG(6,
			    "usb_mid_sensor_is600_mode: chip=%p, dpi=%d, TRUE\n",
			    (void *) chip, dpi);
			return TRUE;
		default:
			DBG(3,
			    "usb_mid_sensor_is600_mode: unmatched dpi: %d\n",
			    dpi);
			return FALSE;
			break;
		}
...
static SANE_Status
usb_mid_sensor_prepare_rgb(ma1017 * chip, int dpi)
{
	if (chip->sensor == ST_CANON300)
...
static SANE_Status
usb_mid_sensor_prepare_mono(ma1017 * chip, int dpi)
{
	if (chip->sensor == ST_CANON300)
...
static SANE_Status
usb_mid_sensor_get_dpi(ma1017 * chip, int wanted_dpi, int * dpi)
{
	int *dpi_list;
	int i;
...
static int usb_mid_motor1200_optical_dpi[] =
...
usb_mid_motor1200_prepare_rgb_1200_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_cmt_table(chip, 0, CH_GREEN, FALSE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 1, CH_BLUE, FALSE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 2, CH_RED, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 3, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 4, CH_GREEN, FALSE, FALSE));
	...
	RIE(usb_low_set_motor_movement
	    (chip, FALSE, TRUE, FALSE));
	RIE(usb_low_set_io_3(chip, FALSE));
...
usb_mid_motor1200_prepare_rgb_400_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_cmt_table(chip, 0, CH_GREEN, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 1, CH_BLUE, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 2, CH_RED, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 3, CH_GREEN, FALSE, FALSE));
	...
	RIE(usb_low_set_motor_movement
	    (chip, FALSE, TRUE, FALSE));
	RIE(usb_low_set_io_3(chip, TRUE));
...
usb_mid_motor1200_prepare_rgb_300_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_cmt_table(chip, 1, CH_BLUE, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 2, CH_RED, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 3, CH_GREEN, TRUE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 4, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table_length(chip, 4));
	RIE(usb_low_set_cmt_second_position(chip, 0));
	RIE(usb_low_set_cmt_loop_count(chip, 0xefff));
...
usb_mid_motor1200_prepare_rgb_50_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_cmt_table(chip, 0, CH_GREEN, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 1, CH_GREEN, TRUE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 2, CH_BLUE, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 3, CH_BLUE, TRUE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 4, CH_RED, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 5, CH_RED, TRUE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 6, CH_GREEN, FALSE, FALSE));
...
usb_mid_motor1200_prepare_mono_1200_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_cmt_table(chip, 0, CH_GREEN, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 1, CH_GREEN, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 2, CH_GREEN, FALSE, FALSE));
...
usb_mid_motor1200_prepare_mono_600_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_cmt_table(chip, 0, CH_GREEN, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 1, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 2, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 3, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 4, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 5, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 6, CH_GREEN, TRUE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 7, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 8, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 9, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table
	    (chip, 10, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table
	    (chip, 11, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 12, CH_GREEN, TRUE, TRUE));
	RIE(usb_low_set_cmt_table
	    (chip, 13, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table
	    (chip, 14, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table
	    (chip, 15, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 16, CH_GREEN, TRUE, FALSE));
	RIE(usb_low_set_cmt_table
	    (chip, 17, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table
	    (chip, 18, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table
	    (chip, 19, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 20, CH_GREEN, TRUE, TRUE));
	RIE(usb_low_set_cmt_table
	    (chip, 21, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 22, CH_GREEN, TRUE, FALSE));
	RIE(usb_low_set_cmt_table
	    (chip, 23, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 24, CH_GREEN, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 25, CH_GREEN, TRUE, FALSE));
	RIE(usb_low_set_cmt_table
	    (chip, 26, CH_GREEN, FALSE, FALSE));
...
usb_mid_motor1200_prepare_mono_400_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_cmt_table(chip, 0, CH_GREEN, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 1, CH_GREEN, TRUE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 2, CH_GREEN, TRUE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 3, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table_length(chip, 3));
	RIE(usb_low_set_cmt_second_position(chip, 0));
	RIE(usb_low_set_cmt_loop_count(chip, 0xefff));
...
usb_mid_motor1200_prepare_mono_50_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_cmt_table(chip, 2, CH_GREEN, TRUE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 3, CH_GREEN, TRUE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 4, CH_GREEN, TRUE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 5, CH_GREEN, TRUE, FALSE));
	RIE(usb_low_set_cmt_table(chip, 6, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table_length(chip, 6));
	RIE(usb_low_set_cmt_second_position(chip, 0));
	RIE(usb_low_set_cmt_loop_count(chip, 0xefff));
...
usb_mid_motor1200_prepare_rgb_half_300_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_cmt_table(chip, 0, CH_GREEN, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 1, CH_GREEN, FALSE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 2, CH_BLUE, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 3, CH_BLUE, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 4, CH_RED, FALSE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 5, CH_RED, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 6, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table_length(chip, 6));
	RIE(usb_low_set_cmt_second_position(chip, 0));
	RIE(usb_low_set_cmt_loop_count(chip, 0xefff));
...
usb_mid_motor1200_prepare_rgb_bi_full_300_dpi(ma1017 * chip)
{
	...
	RIE(usb_low_set_cmt_table(chip, 0, CH_GREEN, FALSE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 1, CH_GREEN, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 2, CH_BLUE, FALSE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 3, CH_BLUE, FALSE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 4, CH_RED, TRUE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 5, CH_RED, FALSE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 6, CH_GREEN, FALSE, FALSE));
	RIE(usb_low_set_cmt_table_length(chip, 6));
	RIE(usb_low_set_cmt_second_position(chip, 0));
	RIE(usb_low_set_cmt_loop_count(chip, 0xefff));
...
SANE_Status
usb_mid_motor1200_prepare_rgb(ma1017 * chip, int dpi)
{
	SANE_Status status;

	DBG(6, "usb_mid_motor1200_prepare_rgb: start\n");
	RIE(usb_low_move_motor_home(chip, FALSE, FALSE));
	/* No Motor & Forward */
	RIE(usb_low_set_motor_direction(chip, FALSE));
	RIE(usb_low_enable_motor(chip, TRUE));
	switch (dpi) {
	case 1200:
...
SANE_Status
usb_mid_motor1200_prepare_mono(ma1017 * chip, int dpi)
{
	SANE_Status status;
...
SANE_Status
usb_mid_motor1200_prepare_calibrate_rgb(ma1017 * chip, int dpi)
{
	SANE_Status status;
	...
	default:
		DBG(3,
		    "usb_mid_motor1200_prepare_calibrate_rgb: unmatched dpi: "
		    "%d\n", dpi);
		return SANE_STATUS_INVAL;
		break;
	}
...
SANE_Status
usb_mid_motor1200_prepare_calibrate_mono(ma1017 * chip, int dpi)
{
	SANE_Status status;
	...
	default:
		DBG(3,
		    "usb_mid_motor1200_prepare_calibrate_mono: unmatched dpi: %d\n",
		    dpi);
		return SANE_STATUS_INVAL;
		break;
	}
...
SANE_Status
usb_mid_motor1200_prepare_step(ma1017 * chip, int step_count)
{
	SANE_Status status;
	...
	RIE(usb_low_set_motor_movement
	    (chip, TRUE, TRUE, FALSE));
	/* Make it in 600dpi */
	RIE(usb_low_set_io_3(chip, TRUE));	/* (IO3) ? High power : Low power */
	RIE(usb_low_move_motor_home(chip, FALSE, FALSE));
	/* No Motor & Forward */
	if (step_count == 1) {
		RIE(usb_low_set_cmt_table
		    (chip, 0, CH_GREEN, TRUE, FALSE));
		RIE(usb_low_set_cmt_table
		    (chip, 1, CH_GREEN, FALSE, FALSE));
		...
		RIE(usb_low_set_cmt_table
		    (chip, 0, CH_GREEN, TRUE, FALSE));
		RIE(usb_low_set_cmt_table
		    (chip, 1, CH_GREEN, TRUE, FALSE));
		RIE(usb_low_set_cmt_table
		    (chip, 2, CH_GREEN, TRUE, FALSE));
		RIE(usb_low_set_cmt_table
		    (chip, 3, CH_GREEN, FALSE, FALSE));
		RIE(usb_low_set_cmt_table_length(chip, 3));
...
usb_mid_motor1200_prepare_home(ma1017 * chip)
{
	...
	/* Make it in 600dpi */
	RIE(usb_low_set_io_3(chip, TRUE));	/* (IO3) ? High power : Low power */
	RIE(usb_low_move_motor_home(chip, TRUE, TRUE));
...
usb_mid_motor1200_prepare_adjust(ma1017 * chip, Channel channel)
{
	...
	RIE(usb_low_set_cmt_table(chip, 0, channel, FALSE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 1, channel, FALSE, TRUE));
	RIE(usb_low_set_cmt_table(chip, 2, channel, FALSE, FALSE));
	RIE(usb_low_set_cmt_table_length(chip, 2));
	RIE(usb_low_set_cmt_second_position(chip, 0));
	RIE(usb_low_set_cmt_loop_count(chip, 0xefff));
...
int
usb_mid_motor1200_rgb_capability(int dpi)
{
	...
	default:
		DBG(3,
		    "usb_mid_motor1200_rgb_capability: unmatched dpi: %d\n",
		    dpi);
		return 0;
	}
}
...
int
usb_mid_motor1200_mono_capability(int dpi)
{
	...
	default:
		DBG(3,
		    "usb_mid_motor1200_mono_capability: unmatched dpi: %d\n",
		    dpi);
		return 0;
	}
}
...
static int usb_mid_motor600_optical_dpi[] =
...
SANE_Status
usb_mid_motor600_prepare_rgb(ma1017 * chip, int dpi)
{
...
SANE_Status
usb_mid_motor600_prepare_mono(ma1017 * chip, int dpi)
{
...
SANE_Status
usb_mid_motor600_prepare_calibrate_rgb(ma1017 * chip, int dpi)
{
	SANE_Status status;
	...
	default:
		DBG(3,
		    "usb_mid_motor600_prepare_calibrate_rgb: unmatched dpi: %d\n",
		    dpi);
		return SANE_STATUS_INVAL;
		break;
	}
...
SANE_Status
usb_mid_motor600_prepare_calibrate_mono(ma1017 * chip, int dpi)
{
	SANE_Status status;
	...
	default:
		DBG(3,
		    "usb_mid_motor600_prepare_calibrate_mono: unmatched dpi: %d\n",
		    dpi);
		return SANE_STATUS_INVAL;
		break;
	}
...
SANE_Status
usb_mid_motor600_prepare_step(ma1017 * chip, int step_count)
{
	SANE_Status status;
...
int
usb_mid_motor600_rgb_capability(int dpi)
{
...
int
usb_mid_motor600_mono_capability(int dpi)
{
	...
	default:
		DBG(3,
		    "usb_mid_motor600_mono_capability: unmatched dpi: %d\n",
		    dpi);
		return 0;
	}
}
...
static SANE_Status
usb_mid_motor_prepare_rgb(ma1017 * chip, int dpi)
{
	if (chip->motor == MT_600)
...
static SANE_Status
usb_mid_motor_prepare_mono(ma1017 * chip, int dpi)
{
	if (chip->motor == MT_600)
...
static SANE_Status
usb_mid_motor_prepare_calibrate_rgb(ma1017 * chip, int dpi)
{
	if (chip->motor == MT_600)
...
static SANE_Status
usb_mid_motor_prepare_calibrate_mono(ma1017 * chip, int dpi)
{
	if (chip->motor == MT_600)
...
static SANE_Status
usb_mid_motor_prepare_step(ma1017 * chip, int step_count)
{
	if (chip->motor == MT_600)
...
static int
usb_mid_motor_rgb_capability(ma1017 * chip, int dpi)
{
	if (chip->motor == MT_600)
...
static int
usb_mid_motor_mono_capability(ma1017 * chip, int dpi)
{
	if (chip->motor == MT_600)
...
static SANE_Status
usb_mid_motor_get_dpi(ma1017 * chip, int wanted_dpi, int * dpi)
{
	int *dpi_list;
	int i;
