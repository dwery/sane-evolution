...
#define SANE_EVOLUTION_MAGIC	0x20070820
...
typedef enum
{
	...
	SANE_STATUS_WARMING_UP	/* (1.1) scanner is warming up */
}
SANE_Status;
...
typedef enum
{
	...
	SANE_FRAME_XML = 0x0A,	/* SANE 1.1 compliant XML data */
...
#define SANE_FRAME_TEXT SANE_FRAME_XML
