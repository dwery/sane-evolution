...
static const char RCSid_h[] =
	"$Header: /org/alioth.debian.org/chroot/cvsroot/sane/sane-backends/backend/sp15c.h,v 1.7 2005-09-19 19:57:48 fzago-guest Exp $";
...
#define length_quant SANE_UNFIX(SANE_FIX(SANE_MM_PER_INCH / 1200.0))
...
static void adjust_width(struct sp15c *s, int * info);
