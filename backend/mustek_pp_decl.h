...
static void debug_drv_capabilities(SANE_Int info, SANE_String * model,
				   ...
				   SANE_Int * caps);
static SANE_Status debug_drv_open(SANE_String port, SANE_Int caps,
				  SANE_Int * fd);
...
static SANE_Status cis_drv_open(SANE_String port, SANE_Int caps,
				SANE_Int * fd);
...
static void ccd300_capabilities(SANE_Int info,
				...
				SANE_Int * maxhsize,
				SANE_Int * maxvsize, SANE_Int * caps);
static SANE_Status ccd300_open(SANE_String port, SANE_Int caps,
			       SANE_Int * fd);
