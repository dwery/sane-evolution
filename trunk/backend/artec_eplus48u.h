...
typedef enum Artec48U_Scan_Action
{
	...
	SA_CALIBRATE_SCAN_OFFSET_1,
				/**< First scan to determin offset       */
	SA_CALIBRATE_SCAN_OFFSET_2,
				/**< Second scan to determine offset     */
	SA_CALIBRATE_SCAN_EXPOSURE_1,
				  /**< First scan to determin offset       */
	SA_CALIBRATE_SCAN_EXPOSURE_2,
				  /**< Second scan to determine offset     */
	SA_SCAN			/**< Normal scan */
}
...
struct Artec48U_Scanner
{
	...
	int gamma_array[4][65536];
	int contrast_array[65536];
	int brightness_array[65536];
 ...
 */
static SANE_Status
artec48u_device_memory_write(Artec48U_Device * dev, int addr,
 ...
 */
static SANE_Status
artec48u_device_memory_read(Artec48U_Device * dev, int addr,
			    int size, SANE_Byte * data);
