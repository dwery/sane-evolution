...
/* 
	$Id: teco1.h,v 1.9 2005-07-07 11:55:42 fzago-guest Exp $
*/
...
typedef struct Teco_Scanner
{
	...
	int gamma_GRAY[MAX_GAMMA_LENGTH];
	int gamma_R[MAX_GAMMA_LENGTH];
	int gamma_G[MAX_GAMMA_LENGTH];
	int gamma_B[MAX_GAMMA_LENGTH];
}
Teco_Scanner;
